...
namespace d3d_vtable {
	...
	static void init_imgui(IDXGISwapChain* device) noexcept
	{
		...
		colors[ImGuiCol_WindowBg] = ImVec4(0.114f, 0.102f, 0.184f, 1.00f);
		colors[ImGuiCol_ChildBg] = ImVec4(0.114f, 0.102f, 0.184f, 0.00f);
		colors[ImGuiCol_PopupBg] = ImVec4(0.114f, 0.102f, 0.184f, 0.94f);
		colors[ImGuiCol_Border] = ImVec4(0.114f, 0.102f, 0.184f, 1.00f);
		colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
		colors[ImGuiCol_FrameBg] = ImVec4(0.114f, 0.102f, 0.184f, 1.00f);
		colors[ImGuiCol_FrameBgHovered] = ImVec4(0.114f, 0.102f, 0.184f, 1.00f);
		colors[ImGuiCol_FrameBgActive] = ImVec4(0.114f, 0.102f, 0.184f, 1.00f);
		colors[ImGuiCol_TitleBg] = ImVec4(0.451f, 0.31f, 0.604f, 1.00f);
		colors[ImGuiCol_TitleBgActive] = ImVec4(0.588f, 0.373f, 0.831f, 1.00f);
		colors[ImGuiCol_TitleBgCollapsed] = ImVec4(1.0f, 1.0f, 1.0f, 0.51f);
		colors[ImGuiCol_MenuBarBg] = ImVec4(0.365f, 0.467f, 0.329f, 1.00f);
		colors[ImGuiCol_ScrollbarBg] = ImVec4(0.114f, 0.102f, 0.184f, 0.53f);
		colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.545f, 0.831f, 0.314f, 1.00f);
		colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.545f, 0.831f, 0.314f, 1.00f);
		colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.545f, 0.831f, 0.314f, 1.00f);
		colors[ImGuiCol_CheckMark] = ImVec4(0.545f, 0.831f, 0.314f, 1.00f);
		colors[ImGuiCol_SliderGrab] = ImVec4(0.545f, 0.831f, 0.314f, 1.00f);
		colors[ImGuiCol_SliderGrabActive] = ImVec4(0.545f, 0.831f, 0.314f, 1.00f);
		colors[ImGuiCol_Button] = ImVec4(0.451f, 0.31f, 0.604f, 1.00f);
		colors[ImGuiCol_ButtonHovered] = ImVec4(0.588f, 0.373f, 0.831f, 1.00f);
		colors[ImGuiCol_ButtonActive] = ImVec4(0.588f, 0.373f, 0.831f, 1.00f);
		colors[ImGuiCol_Header] = ImVec4(0.451f, 0.31f, 0.604f, 1.00f);
		colors[ImGuiCol_HeaderHovered] = ImVec4(0.588f, 0.373f, 0.831f, 1.00f);
		colors[ImGuiCol_HeaderActive] = ImVec4(0.588f, 0.373f, 0.831f, 1.00f);
		colors[ImGuiCol_Separator] = ImVec4(0.545f, 0.831f, 0.314f, 1.00f);
		colors[ImGuiCol_SeparatorHovered] = ImVec4(0.545f, 0.831f, 0.314f, 1.00f);
		colors[ImGuiCol_SeparatorActive] = ImVec4(0.545f, 0.831f, 0.314f, 1.00f);
		colors[ImGuiCol_ResizeGrip] = ImVec4(0.643f, 0.886f, 0.557f, 1.00f);
		colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.247f, 0.427f, 0.306f, 1.00f);
		colors[ImGuiCol_ResizeGripActive] = ImVec4(0.78f, 0.55f, 0.21f, 1.00f);
		colors[ImGuiCol_Tab] = ImVec4(0.451f, 0.31f, 0.604f, 1.00f);
		colors[ImGuiCol_TabHovered] = ImVec4(0.588f, 0.373f, 0.831f, 1.00f);
		colors[ImGuiCol_TabActive] = ImVec4(0.588f, 0.373f, 0.831f, 1.00f);
